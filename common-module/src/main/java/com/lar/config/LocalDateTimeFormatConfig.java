...
public class LocalDateTimeFormatConfig {
     ...
     * 序列化
     */
    public static class LocalDateTimeSerializerNum extends JsonSerializer<LocalDateTime> {
        @Override
    ...
    public class DateFormatterSerializer extends JsonSerializer<Object> implements Formatter<Date> {
